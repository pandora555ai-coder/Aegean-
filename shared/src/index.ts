...
export const PRESET_NAMES: readonly string[] = [
  ...
  // masculine (Task 245, 45 more)
  'Δημήτρης', 'Θανάσης', 'Θόδωρος', 'Στέφανος', 'Άγγελος', 'Αλέξανδρος', 'Απόστολος',
  'Αριστείδης', 'Δημοσθένης', 'Ελευθέριος', 'Εμμανουήλ', 'Ευάγγελος', 'Ζήσης', 'Θεόδωρος',
  'Ιάσονας', 'Ιωάννης', 'Κλέαρχος', 'Λεωνίδας', 'Μενέλαος', 'Νεκτάριος', 'Παναγής',
  'Πλάτωνας', 'Πολύκαρπος', 'Σάββας', 'Σεραφείμ', 'Σίμος', 'Σταμάτης', 'Τρύφωνας',
  'Χαράλαμπος', 'Ιάκωβος', 'Ματθαίος', 'Μάρκος', 'Ραφαήλ', 'Γαβριήλ', 'Μιλτιάδης',
  'Νικηφόρος', 'Θεοφάνης', 'Ευστάθιος', 'Κοσμάς', 'Παρασκευάς', 'Πάνος', 'Γιωργάκης',
  'Δημητράκης', 'Θύμιος', 'Ορφέας',
  // feminine (Task 245, 57 more)
  'Αικατερίνη', 'Χριστίνα', 'Κωνσταντίνα', 'Μαργαρίτα', 'Νικολέτα', 'Ξένια', 'Ολυμπία',
  'Ρωξάνη', 'Σταματία', 'Φωτεινή', 'Χαρίκλεια', 'Ηλέκτρα', 'Ιουλία', 'Καλλιόπη',
  'Λαμπρινή', 'Μελίνα', 'Μυρτώ', 'Ουρανία', 'Πηνελόπη', 'Ραφαέλα', 'Στέλλα', 'Τατιάνα',
  'Φιλίτσα', 'Αφροδίτη', 'Άρτεμις', 'Ελισάβετ', 'Ζωίτσα', 'Θεανώ', 'Κυριακή', 'Λυδία',
  'Ναταλία', 'Πολυξένη', 'Ρέα', 'Σεβαστή', 'Τερψιχόρη', 'Υπατία', 'Χρυσή', 'Άλκηστη',
  'Βέρα', 'Γιώτα', 'Δέσποινα', 'Ελπίδα', 'Ζαχαρούλα', 'Λίνα', 'Βίκυ', 'Ζωζώ', 'Φρόσω',
  'Ασπασία', 'Ασημίνα', 'Ερασμία', 'Θεοδοσία', 'Καλλιρόη', 'Μαρκέλλα', 'Ξανθίππη',
  'Παρθένα', 'Σμαράγδα', 'Χρυσάνθη',
];
...
export const VOCATIVE_FORMS: Readonly<Record<string, string>> = {
  ...
  'Όλγα': 'Όλγα',
  'Λένα': 'Λένα',
  // Task 245 - copied verbatim from the task's own literal table, NOT
  // derived: most masculine -ΟΣ/-ΗΣ/-ΑΣ names still just drop the final Σ,
  // but a proparoxytone -ΟΣ name takes -Ε instead (Αλέξανδρος -> Αλέξανδρε,
  // Θεόδωρος -> Θεόδωρε) while a paroxytone one keeps -Ο (Μάρκος -> Μάρκο,
  // Πάνος -> Πάνο) - see the block comment at the top of this table for the
  // three masculine cases and the four indeclinables (Εμμανουήλ, Ραφαήλ,
  // Γαβριήλ, Σεραφείμ, all unchanged).
  'Δημήτρης': 'Δημήτρη',
  'Θανάσης': 'Θανάση',
  'Θόδωρος': 'Θόδωρε',
  'Στέφανος': 'Στέφανε',
  ...
  'Απόστολος': 'Απόστολε',
  'Αριστείδης': 'Αριστείδη',
  'Δημοσθένης': 'Δημοσθένη',
  'Ελευθέριος': 'Ελευθέριε',
  'Εμμανουήλ': 'Εμμανουήλ',
  'Ευάγγελος': 'Ευάγγελε',
  'Ζήσης': 'Ζήση',
  'Θεόδωρος': 'Θεόδωρε',
  ...
  'Πάνος': 'Πάνο',
  'Γιωργάκης': 'Γιωργάκη',
  'Δημητράκης': 'Δημητράκη',
  'Θύμιος': 'Θύμιο',
  'Ορφέας': 'Ορφέα',
  // Task 245 - feminine, vocative = nominative for all 57 (same as every
  // feminine entry above).
...
// Task 247 - the grammatical GENDER of every PRESET_NAMES entry. Copied
// explicitly from the gender groups PRESET_NAMES itself is written in (the
// four "// masculine" / "// feminine" blocks above), NEVER inferred from the
// ending: the ending is not decisive in Greek, and a suffix rule cannot
// classify Κώστας/Ξενοφών/Άρτεμις/Ελισάβετ/Βάσω at all. Used for the winner
// screen's title (Ο ΣΟΦΙΣΤΗΣ / Η ΣΟΦΙΣΤΡΙΑ) and to choose the coronation
// line's variant. Kept 1:1 with PRESET_NAMES and VOCATIVE_FORMS - all three
// tables are checked against each other by dev/245-name-check.ts.
export const NAME_GENDER: Readonly<Record<string, 'm' | 'f'>> = {
  // masculine
  'Νίκος': 'm',
  'Γιώργος': 'm',
  'Κώστας': 'm',
...
// null for a name this table does not carry (and for a TIE, whose winnerName
// is several names joined). Callers must degrade rather than guess.
export function genderForName(name: string): 'm' | 'f' | null {
  return NAME_GENDER[name] ?? null;
}

// The winner screen's kicker. Masculine is the DEGRADE for an unknown name -
// it is what the screen said for every winner before this task ("Ο ΜΑΘΗΤΗΣ"),
// so an unknown name is no worse off than it used to be. Rendered through
// greekUpper at the call site, never text-transform (Greek drops the tonos).
export function winnerTitleForName(name: string): string {
  return genderForName(name) === 'f' ? 'Η σοφίστρια' : 'Ο σοφιστής';
}
