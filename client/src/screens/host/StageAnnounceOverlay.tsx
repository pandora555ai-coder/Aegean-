...
// Task 31a/35 - the TV's "here comes round N" card, and the whole view of
...
// Titles/taglines are framed as rounds of a public dispute in Athens, now
// hosted by Socrates (Task 37a) - see STAGES in shared/src/index.ts.
