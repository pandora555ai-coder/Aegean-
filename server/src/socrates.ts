...
export const LINE_TAGS: Partial<Record<string, string>> = {
  ...
  '{category}. Εδώ χωρίζονται όσοι ξέρουν από όσους νομίζουν.': '[serious]',
  'Ώστε φτάσαμε στο θέμα {category}. Ας δούμε ποιος διάβασε.': '[curious]',
  '{category}. Αυτό το θέμα δεν συγχωρεί το μπλόφαρισμα.': '[serious]',
  'Προσοχή τώρα: {category}.': '[curious]',
  '{category}. Κάποιοι από εσάς μόλις χλωμιάσατε.': '[amused]',
  'Θέμα: {category}. Δείξτε μου κάτι.': '[dry]',
  // GENERIC_INTRO (intro)
