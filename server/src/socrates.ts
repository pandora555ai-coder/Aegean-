...
export const DRAW_LINES: Record<DrawMoment, readonly string[]> = {
  ...
  SPLIT_GUESS: [
    ...
    // Task 146 additions.
    'Άλλος είδε ένα πράγμα και άλλος κάτι εντελώς άλλο, στο ίδιο ακριβώς χαρτί. Αναρωτιέμαι ποιος από εσάς κοίταξε και ποιος φαντάστηκε.',
  ...
  DRAW_WINNER: [
    ...
    // Task 146 additions.
    'Κάποιος έκανε τους άλλους να δουν αυτό που είχε στο μυαλό του, χωρίς μία λέξη. Εγώ χρειάζομαι ώρες συζήτησης για το ίδιο πράγμα.',
...
export const NUMERIC_LINES: Record<NumericMoment, readonly string[]> = {
  ...
  ALL_CLUSTERED: [
    ...
    // Task 146 additions.
    'Τα νούμερά σας έπεσαν όλα στο ίδιο σημείο, χωρίς κανείς να συμβουλευτεί κανέναν. Αναρωτιέμαι αν σκέφτεστε ή αν απλώς θυμάστε τα ίδια πράγματα.',
    'Όλες οι εκτιμήσεις μαζεμένες σε μια σπιθαμή. Αν είναι λάθος, θα έχετε τουλάχιστον παρέα στην πτώση.',
    'Συμφωνήσατε χωρίς να ανταλλάξετε λέξη, και αυτό δεν με καθησυχάζει καθόλου. Έτσι καταλήγει μια ολόκληρη πόλη να κάνει το ίδιο λάθος.',
...
export const LINE_TAGS: Partial<Record<string, string>> = {
  ...
  // ALL_CLUSTERED
  'Τα νούμερά σας έπεσαν όλα στο ίδιο σημείο, χωρίς κανείς να συμβουλευτεί κανέναν. Αναρωτιέμαι αν σκέφτεστε ή αν απλώς θυμάστε τα ίδια πράγματα.': '[curious]',
  'Όλες οι εκτιμήσεις μαζεμένες σε μια σπιθαμή. Αν είναι λάθος, θα έχετε τουλάχιστον παρέα στην πτώση.': '[deadpan]',
  'Συμφωνήσατε χωρίς να ανταλλάξετε λέξη, και αυτό δεν με καθησυχάζει καθόλου. Έτσι καταλήγει μια ολόκληρη πόλη να κάνει το ίδιο λάθος.': '[serious]',
  ...
  // SPLIT_GUESS
  'Άλλος είδε ένα πράγμα και άλλος κάτι εντελώς άλλο, στο ίδιο ακριβώς χαρτί. Αναρωτιέμαι ποιος από εσάς κοίταξε και ποιος φαντάστηκε.': '[curious]',
  ...
  // DRAW_WINNER
  'Κάποιος έκανε τους άλλους να δουν αυτό που είχε στο μυαλό του, χωρίς μία λέξη. Εγώ χρειάζομαι ώρες συζήτησης για το ίδιο πράγμα.': '[impressed]',
